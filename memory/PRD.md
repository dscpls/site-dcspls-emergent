# DISCÍPULOS - Site da Banda

## Problema Original
Site para banda de hip-hop alternativo DISCÍPULOS, inspirada em BROCKHAMPTON. Estética MySpace anos 2000 com GIFs, bordas neon, paleta de cores ciano e amarelo baseada no álbum "Fases".

## Arquitetura
- **Frontend**: React.js com Tailwind CSS
- **Estilo**: MySpace 2000s (fontes pixeladas VT323/Press Start 2P, bordas neon, emojis animados)
- **Paleta**: Ciano (#00CED1) e Amarelo (#FFD700)

## User Personas
- Fãs de hip-hop alternativo brasileiro
- Jovens nostálgicos da era MySpace/2000s
